...
<?php if (comments_open()) : ?>
    ...
    <section id="comments" class="comments">
        ...
        <div class="comments-main">
            <h3 id="comments-list-title"><?php _e('Comments', 'sakurairo'); ?> <span class="noticom"><?php comments_number('NOTHING', '1' . __(" comment", "sakurairo"), '%' . __(" comments", "sakurairo")); ?> </span></h3>
