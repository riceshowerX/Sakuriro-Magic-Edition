...
?>
<?php send_headers('X-Frame-Options: SAMEORIGIN'); ?>
<!DOCTYPE html>
<!-- 
            ◢＼　 ☆　　 ／◣
    　  　∕　　﹨　╰╮∕　　﹨
...
<head>
    ...
    <?php
    if (function_exists('iro_opt') && iro_opt('iro_meta')) {
        $keywords = '';
        $description = '';
        if (is_singular()) {
            $keywords = '';
...
<body <?php body_class(); ?>>
    ...
    <section id="main-container">
        <?php
        if (function_exists('iro_opt') && iro_opt('cover_switch')) {
